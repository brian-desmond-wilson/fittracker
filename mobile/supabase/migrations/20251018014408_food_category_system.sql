-- Food Category System Migration
-- This migration creates the new category/subcategory system for food inventory

-- Create food_categories table (major categories)
...
CREATE INDEX idx_food_inventory_category_map_food_id ON food_inventory_category_map(food_inventory_id);
CREATE INDEX idx_food_inventory_category_map_category_id ON food_inventory_category_map(category_id);
CREATE INDEX idx_food_inventory_category_map_user_id ON food_inventory_category_map(user_id);
CREATE INDEX idx_food_inventory_subcategory_map_food_id ON food_inventory_subcategory_map(food_inventory_id);
CREATE INDEX idx_food_inventory_subcategory_map_subcategory_id ON food_inventory_subcategory_map(subcategory_id);
CREATE INDEX idx_food_inventory_subcategory_map_user_id ON food_inventory_subcategory_map(user_id);
...
-- Seed data: Insert major categories
